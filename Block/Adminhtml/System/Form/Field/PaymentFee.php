...
namespace AHT\PaymentFee\Block\Adminhtml\System\Form\Field;

use AHT\PaymentFee\Model\Config\ActiveMethods;
    ...
    protected function _getPaymentRenderer()
    {
        if (!$this->_typeRenderer) {
            $this->_typeRenderer = $this->getLayout()->createBlock(
                'AHT\PaymentFee\Block\Adminhtml\System\Form\Field\Methods',
                '',
